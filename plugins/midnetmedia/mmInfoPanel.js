(function () {
    ...
    var mmInfoPanel = function (settings) {
        ...
        var ipPump = $('<svg class="ip-pump" width="120px" height="116px" viewBox="0 0 120 116" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="pump-copy" transform="translate(-95.000000, -46.000000)"><g id="PumpIconMaster3_300x250" transform="translate(95.000000, 46.000000)"><path d="M114.197053,34.7418947 L114.197053,30.1806316 L102.165474,30.1806316 C107.753684,38.8383158 111.012632,49.1330526 111.012632,60.1793684 C111.012632,90.7768421 86.1221053,115.666105 55.5296842,115.666105 C24.9322105,115.666105 0.0416842105,90.7768421 0.0416842105,60.1806316 C0.0416842105,29.8231579 24.5557895,5.09052632 54.8286316,4.71284211 L54.8286316,4.69263158 L114.197053,4.69263158 L114.197053,0.133894737 L119.536421,0.133894737 L119.536421,4.69263158 L119.536421,30.1806316 L119.536421,34.7418947 L114.197053,34.7418947 Z" class="ip-pump-layer1" fill="#d9d9d9"></path><path d="M91.1494737,25.2315789 C99.9915789,34.2467368 105.461053,46.584 105.461053,60.1793684 C105.461053,87.7162105 83.0602105,110.114526 55.5296842,110.114526 C27.9915789,110.114526 5.592,87.7162105 5.592,60.1806316 C5.592,33.2665263 26.9987368,11.2673684 53.6791579,10.2909474 L53.6791579,10.2442105 L114.197053,10.2442105 L114.197053,25.2315789 L91.1494737,25.2315789 Z" class="ip-pump-layer2" fill="#ededed"></path><g id="Group" transform="translate(10.105263, 15.157895)"><circle class="ip-pump-layer3" fill="#d9d9d9" cx="45.7528421" cy="45.2071579" r="44.7461053"></circle><path d="M86.592,26.9242105 C83.4833684,38.6665263 72.7882105,47.3254737 60.0669474,47.3254737 C56.5275789,47.3254737 53.1461053,46.6484211 50.04,45.4269474 C50.04,45.4282105 50.04,45.432 50.04,45.4345263 C50.0425263,45.3587368 50.0513684,45.2842105 50.0513684,45.2071579 C50.0513684,42.8311579 48.1275789,40.9073684 45.7528421,40.9073684 C44.0867368,40.9073684 42.648,41.8585263 41.9330526,43.2404211 C38.6753684,41.9873684 35.1397895,41.2926316 31.44,41.2926316 C18.6732632,41.2926316 7.824,49.4791579 3.83873684,60.8867368 C4.16842105,61.7684211 4.53094737,62.6336842 4.91494737,63.4888421 C8.02357895,51.7477895 18.7187368,43.0888421 31.44,43.0888421 C34.9793684,43.0888421 38.3595789,43.7671579 41.4669474,44.9873684 C41.4669474,44.9861053 41.4669474,44.9861053 41.4669474,44.9861053 C41.4631579,45.0593684 41.4555789,45.1326316 41.4555789,45.2084211 C41.4555789,47.5818947 43.3793684,49.5056842 45.7541053,49.5056842 C47.4227368,49.5056842 48.8652632,48.5507368 49.5802105,47.1625263 C49.5776842,47.1663158 49.5764211,47.1701053 49.5738947,47.1713684 C52.8315789,48.4269474 56.3684211,49.1216842 60.0682105,49.1216842 C72.8349474,49.1216842 83.6829474,40.9364211 87.6707368,29.5275789 C87.3385263,28.6446316 86.9747368,27.7793684 86.592,26.9242105 Z" class="ip-pump-layer4" fill="#ededed" fill-rule="nonzero"></path></g></g></g></g></svg>')
        ...
        this.onCalculatedValueChanged = function (settingName, newValue) {
            ...
            if (settingName == "ip_rpm") {
                if (newValue > 0) {
                    document.getElementById(thisWidgetId).getElementsByClassName('ip-pump-layer1')[0].style.fill = '#C4DEB5'
                    document.getElementById(thisWidgetId).getElementsByClassName('ip-pump-layer2')[0].style.fill = '#E1EEDA'
                    document.getElementById(thisWidgetId).getElementsByClassName('ip-pump-layer3')[0].style.fill = '#C4DEB5'
                    document.getElementById(thisWidgetId).getElementsByClassName('ip-pump-layer4')[0].style.fill = '#E1EEDA'
                }
                if (newValue === 0) {
                    document.getElementById(thisWidgetId).getElementsByClassName('ip-pump-layer1')[0].style.fill = '#D9D9D9'
                    document.getElementById(thisWidgetId).getElementsByClassName('ip-pump-layer2')[0].style.fill = '#EDEDED'
                    document.getElementById(thisWidgetId).getElementsByClassName('ip-pump-layer3')[0].style.fill = '#D9D9D9'
                    document.getElementById(thisWidgetId).getElementsByClassName('ip-pump-layer4')[0].style.fill = '#EDEDED'
                }
            }
