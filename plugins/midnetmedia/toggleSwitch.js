(function () {
    ...
    freeboard.addStyle('.floating-box', "display: inline-block; vertical-align: top; width: 78px; margin-top: 10px; margin-right: 5px;");
    ...
    var wswitch = function (settings) {
        ...
        var box2 = $('<div class="floating-box onoffswitch-title">' + settings.ts_title + '</div>');
        ...
        this.onSettingsChanged = function (newSettings) {
            ...
            box2.html((_.isUndefined(newSettings.ts_title) ? "" : newSettings.ts_title));
            console.log("isUndefined ts_ontext: " + _.isUndefined(newSettings.ts_ontext));
            onText = newSettings.ts_ontext;
            offText = newSettings.ts_offtext;
            updateState();
        }
