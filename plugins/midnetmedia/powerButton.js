(function () {
    ...
    freeboard.loadWidgetPlugin({
        type_name: "powerButton",
        display_name: "Power Button",
        description: "send and receive state",
        settings: [
            {
                name: "title",
                display_name: "Title",
        ...
        newInstance: function (settings, newInstanceCallback) {
            newInstanceCallback(new powerButton(settings));
        }
    });
    ...
    var powerButton = function (settings) {
        var self = this;
        ...
        this.onClick = function(e) {
            ...
            var new_val = !isOn
            this.onCalculatedValueChanged('pb_value', new_val);
